...
<AuthCard title="Delete account" subtitle={data.email}>
	...
	<form method="post" use:enhance class="mt-4 space-y-4">
		...
		<button
			type="submit"
			class="w-full rounded-lg bg-red-600 px-4 py-2.5 font-semibold text-white transition hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:outline-none"
		>
			Delete my account
		</button>
	</form>
