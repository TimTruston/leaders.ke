<script lang="ts">
	...
	// The homepage sells to the paying customer (candidates and incumbents);
	...
	const toolkit = [
		...
		{
			title: 'Endorsements & fundraising',
			description:
				'Display pledges and notable supporters, then collect campaign donations via M-Pesa.',
			live: false,
	...
	<div class="relative mx-auto grid max-w-7xl gap-5 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
		<div class="flex flex-col justify-center">
			...
			<p class="mt-4 max-w-lg text-base leading-relaxed">
				...
				candidates and incumbents; open to every citizen ahead of the 2027 General Elections.
			</p>
