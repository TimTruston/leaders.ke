<script lang="ts">
	...
	// `data` and hosts ?/save plus the manifesto pillar actions.
...
<div>
	...
	<!-- Manifesto: the itemized, publicly trackable promises for this run. Each
	pillar is its own immediate-submit form (add/edit/delete/reorder), separate
	from the campaign details form above. -->
